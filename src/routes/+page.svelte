  ...
  <div class="g-top text-light">
    <div class="top-remote-video-show-wrap d-flex">
      ...
      >
        ...
        >
          ...
          <div
            class="chat-heading d-flex just-content-round align-items-center cursor-pointer"
          >
            ...
            >
              <div class="chat-message-sent-input" style="width: 85%">
                <input
                  type="text"
                  name=""
                  class="chat-message-sent-input-field input-lg w-100 pl-2"
                  id="msgbox"
    ...
    >
      <div class="top-left-participant-wrap pt-2 cursor-pointer">
        ...
        <span
          class="top-left-participant-count participant-count badge badge-success"
          >1</span
        >
      </div>
  ...
  >
    <div class="bottom-left d-flex" style="height: 10vh">
      <div
        ...
        style="display: none; min-height: 19.5vh"
      >
        <div
        ...
        >
          ...
          >
            ...
            <div style="margin-top: -5px">Attachment</div>
          </div>
        </div>
              ...
              <span class="copy_info font-weight-bold"
                ...
                <span
                  style="
                      ...
                      border-radius: 5px;
                    "
                  class="link-conf font-weight-bold p-1">Link Copied</span
                ></span
              >
            </div>
          </div>
